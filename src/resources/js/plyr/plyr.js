...
***************************************************************************** */
    ...
    function K(e) {
      try {
        return (
          (t = e),
          "undefined" != typeof Element && k(t, Element)
            ? T(e)
          ...
          case "unhandledrejection":
            (ve = se.onunhandledrejection),
              (se.onunhandledrejection = function (e) {
                return (
                  ue("unhandledrejection", e), !ve || ve.apply(this, arguments)
                );
              });
            break;
          default:
    ...
    function he(e) {
      return (
        void 0 === e && (e = []),
        "Request" in se && k(e[0], Request) && e[0].method
      ...
      return {
        ...
        add: function (i) {
          if (!(void 0 === e || t.length < e))
            return Oe(new x("Not adding Promise due to buffer limit reached."));
          var r = i();
          return (
        ...
        try {
          for (
            ...
            if (m[1])
              try {
                for (
                  var y = ((a = void 0), s(m[1].split(";"))), v = y.next();
                  !v.done;
                  v = y.next()
                ) {
                  c[v.value] = n + g;
    ...
    function gt(e) {
      ...
      return (
        (function (e) {
          ...
          return (
            -1 !== r.indexOf(s) &&
              i.push.apply(i, a(i.splice(r.indexOf(s), 1))),
            i
          );
        })(e).forEach(function (e) {
          (t[e.name] = e),
            (function (e) {
              -1 === mt.indexOf(e.name) &&
                (e.setupOnce(Ye, tt),
                mt.push(e.name),
                pt && L.log("Integration installed: " + e.name));
            })(e);
        }),
        H(t, "initialized", !0),
        t
        ...
        return (
          ...
          (e.prototype.setupIntegrations = function () {
            this._isEnabled() &&
              ...
              (this._integrations = gt(this._options));
          }),
          (e.prototype.getIntegration = function (e) {
            try {
          ...
          (e.prototype._prepareEvent = function (e, t, n) {
            ...
            return (
              ...
              d.then(function (e) {
                return (
                  e &&
                    (e.sdkProcessingMetadata = r(
                      r({}, e.sdkProcessingMetadata),
                      {
          ...
          (e.prototype._processEvent = function (e, t, n) {
            ...
            if (!this._isEnabled())
              return Oe(new x("SDK not enabled, will not capture event."));
    ...
    var kt = (function () {
      ...
      Tt = (function () {
        function e(e) {
          (this._options = e),
            this._options.dsn ||
              (pt && L.warn("No DSN provided, backend will not do anything.")),
    ...
    var Rt =
      ...
      Bt = [
        ...
        function (e) {
          ...
          if (n) {
            ...
            return (
              (s = (t = o(Yt(s, r), 2))[0]),
              jt((r = t[1]), s, n[4] ? +n[4] : void 0, n[5] ? +n[5] : void 0)
            );
          }
        },
      ],
      ...
      Ht = [
        ...
        function (e) {
          var t = Ft.exec(e);
          return t
            ? jt(t[2], t[1] || It, +t[3], t[4] ? +t[4] : void 0)
            : void 0;
        },
      ],
    ...
    function an(e, t) {
      if (
        "[object Navigator]" ===
          Object.prototype.toString.call(sn && sn.navigator) &&
        "function" == typeof sn.navigator.sendBeacon
      )
        return sn.navigator.sendBeacon.bind(sn.navigator)(e, t);
      if (te()) {
        var n = on();
        n(e, {
          body: t,
        ...
        return (
              ...
              if (((this._outcomes = {}), Object.keys(e).length)) {
                ...
                var t,
                  ...
                  a =
                    ((t = s),
                    Ue(
                      (n = this._api.tunnel && P(this._api.dsn))
                        ? {
                            dsn: n,
                          }
                        : {},
          ...
          (e.prototype._handleResponse = function (e) {
            var t = e.requestType,
              ...
              s = e.reject,
              o = Ie(n.status);
            (this._rateLimits = ze(this._rateLimits, i)),
        ...
        (e.prototype.setupOnce = function () {
          ...
          for (var n in t) {
            ...
            i &&
              t[n] &&
              ((e = n),
              rn && L.log("Global Handler attached: " + e),
              i(),
          ...
          (e.prototype.setupOnce = function () {
            ...
            this._options.setTimeout && F(e, "setTimeout", An),
              ...
              this._options.requestAnimationFrame &&
                F(e, "requestAnimationFrame", Pn),
              this._options.XMLHttpRequest &&
                "XMLHttpRequest" in e &&
                F(XMLHttpRequest.prototype, "send", On);
    ...
    function Mn(e) {
      ...
      if ("assert" === e.level) {
        ...
        (t.message =
          "Assertion failed: " + (U(e.args.slice(1), " ") || "console.assert")),
    ...
    function Un(e, t, n, i) {
      if ((void 0 === i && (i = []), !k(t[n], Error) || i.length + 1 >= e))
        return i;
      var r = Jt(t[n]);
    ...
    function Xn(e) {
      if (
        (void 0 === e && (e = {}),
        void 0 === e.defaultIntegrations && (e.defaultIntegrations = Jn),
        void 0 === e.release)
      ) {
        var t = u();
        t.SENTRY_RELEASE &&
    ...
    var ii = function (e) {
      ...
      ui = {
        ...
        empty: function (e) {
          return (
            si(e) ||
            ((ai(e) || li(e) || ci(e)) && !e.length) ||
            (oi(e) && !Object.keys(e).length)
          );
        },
      },
      hi = {
        ...
        github: {
          ...
          url: function (e, t) {
            return "https://api.github.com/repos/"
              .concat(e)
              .concat(ui.string(t) ? "?access_token=".concat(t) : "");
          },
          shareCount: function (e) {
    ...
    function gi() {
      ...
      return ui.object(r)
        ? (Object.keys(r).forEach(function (t) {
            ui.object(r[t])
              ? (!Object.keys(e).includes(t) && Object.assign(e, ti({}, t, {})),
                gi(e[t], r[t]))
              : Object.assign(e, ti({}, t, r[t]));
          }),
      ...
      function e(t, n) {
        ...
        Qn(this, e),
          ...
          ui.element(t)
            ...
            : ui.string(t) &&
              (this.elements.trigger = document.querySelector(t)),
        ...
        ei(
          ...
          [
                  ...
                  if (ui.empty(r))
                    ...
                    (function (e) {
                      ...
                      .then(function (t) {
                        ...
                        (i = ui.empty(r)
                          ? e.networkConfig.shareCount(t)
                          : t[r]),
                          ui.empty(i)
                            ? (i = 0)
                            : ((i = parseInt(i, 10)), !ui.number(i) && (i = 0)),
                          e.storage.set(ti({}, e.target, ti({}, e.network, i))),
                          n(i);
                      })
                      .catch(i);
                  }
            ...
            },
            {
              key: "href",
              get: function () {
                return ui.element(this.elements.trigger)
              ...
              value: function (t) {
                ...
                if (
                  (ui.string(t)
                    ...
                    : ui.nodeList(t)
                    ? (i = Array.from(t))
                    : ui.array(t) && (i = t.filter(ui.element)),
                  ui.empty(i))
                )
                  return null;
    ...
    var Si = function (e) {
      ...
      Li = {
        ...
        empty: function (e) {
          return (
            Ci(e) ||
            ((Pi(e) || Oi(e) || Ni(e)) && !e.length) ||
            (Ai(e) && !Object.keys(e).length)
          );
        },
      };
    function Mi(e, t) {
    ...
    var Ii = (function () {
      function e(t, n) {
        (function (e, t) {
          ...
          Li.element(t)
            ? (this.element = t)
            : Li.string(t) && (this.element = document.querySelector(t)),
          Li.element(this.element) &&
            Li.empty(this.element.rangeTouch) &&
            ((this.config = Ti({}, Ei, {}, n)), this.init());
      }
      return (
        (function (e, t, n) {
                  ...
                  (Li.empty(t) || Li.string(t)
                    ? (i = Array.from(
                        document.querySelectorAll(
                          Li.string(t) ? t : 'input[type="range"]'
                        )
                      ))
                    : Li.element(t)
                    ? (i = [t])
    ...
    function er(e) {
      Vi.nodeList(e) || Vi.array(e)
        ? Array.from(e).forEach(er)
        : Vi.element(e) &&
          Vi.element(e.parentNode) &&
    ...
    function nr(e, t) {
      return Vi.element(t) && Vi.element(t.parentNode) && Vi.element(e)
    ...
    const hr = {
      ...
      dr = {
        ...
        pip: !(
          Ki.isIPhone ||
          (!Vi.function(Qi("video").webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              Qi("video").disablePictureInPicture))
        ),
    ...
    function mr(e, t, n, i = !1, r = !0, s = !1) {
      if (!e || !("addEventListener" in e) || Vi.empty(t) || !Vi.function(n))
        return;
      const o = t.split(" ");
      let a = s;
      pr &&
    ...
    function wr() {
      return new Promise((e) =>
        this.ready
          ? setTimeout(e, 0)
          : fr.call(this, this.elements.container, "ready", e)
      ).then(() => {});
    }
    function _r(e) {
            ...
            set(t) {
              if (e.quality !== t) {
                if (
                  ...
                  Vi.function(e.config.quality.onChange)
                )
                  e.config.quality.onChange(t);
                else {
                  const n = Nr.getSources
                    .call(e)
    ...
    const Wr = {
      ...
      findElements() {
        try {
          return (
            (this.elements.controls = cr.call(
              this,
            ...
            (this.elements.progress = cr.call(
              this,
            ...
            Vi.element(this.elements.progress) &&
      ...
      createButton(e, t) {
        ...
        switch (
          ...
          case "play-large":
            ...
            break;
          default:
            Vi.empty(r.label) && (r.label = i),
              Vi.empty(r.icon) && (r.icon = e);
        }
        const s = Qi(r.element);
        return (
          r.toggle
            ? (s.appendChild(
                Wr.createIcon.call(this, r.iconPressed, {
                  class: "icon--pressed",
                })
              ),
              s.appendChild(
                Wr.createIcon.call(this, r.icon, {
                  class: "icon--not-pressed",
                })
              ),
              s.appendChild(
                Wr.createLabel.call(this, r.labelPressed, {
                  class: "label--pressed",
                })
              ),
              s.appendChild(
                Wr.createLabel.call(this, r.label, {
          ...
          Gi(s, n),
          "play" === i
            ? (Vi.array(this.elements.buttons[i]) ||
      ...
      createRange(e, t) {
        ...
        return (
          ...
          Wr.updateRangeFill.call(this, n),
          Ii.setup(n),
          n
        );
      },
      createProgress(e, t) {
        const n = Qi(
          "progress",
          Ji(
            ir(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
        ...
        fr.call(
          ...
          (n) => {
            ...
            if (!i && [" ", "ArrowRight"].includes(n.key))
              Wr.showMenuPanel.call(this, t, !0);
            else {
              let t;
              " " !== n.key &&
                ("ArrowDown" === n.key || (i && "ArrowRight" === n.key)
                  ? ((t = e.nextElementSibling),
                    Vi.element(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling),
                    Vi.element(t) || (t = e.parentNode.lastElementChild)),
                ur.call(this, t, !0));
            }
          },
          !1
      ...
      updateVolume() {
        this.supported.ui &&
          (Vi.element(this.elements.inputs.volume) &&
            Wr.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          Vi.element(this.elements.buttons.mute) &&
              ...
              (i = this.currentTime),
                ...
                (t =
                  0 === i || 0 === r || Number.isNaN(i) || Number.isNaN(r)
                    ...
                    : ((i / r) * 100).toFixed(2)),
                "timeupdate" === e.type &&
                  Wr.setRange.call(this, this.elements.inputs.seek, t);
              break;
            case "playing":
            case "progress":
      ...
      updateSeekTooltip(e) {
        ...
        if (
          ...
          !Vi.element(this.elements.inputs.seek) ||
          !Vi.element(this.elements.display.seekTooltip) ||
          0 === this.duration
        )
          return;
      ...
      timeUpdate(e) {
        const t =
          !Vi.element(this.elements.display.duration) && this.config.invertTime;
        Wr.updateTimeDisplay.call(
          this,
      ...
      durationUpdate() {
        ...
        if (this.duration >= 2 ** 32)
          return (
            rr(this.elements.display.currentTime, !0),
            void rr(this.elements.progress, !0)
          );
        Vi.element(this.elements.inputs.seek) &&
      ...
      updateSetting(e, t, n) {
        ...
        if ("captions" === e) r = this.currentTrack;
          ...
          if (
            ((r = Vi.empty(n) ? this[e] : n),
            Vi.empty(r) && (r = this.config[e].default),
            !Vi.empty(this.options[e]) && !this.options[e].includes(r))
          )
        ...
        if (
          (Vi.element(s) || (s = i && i.querySelector('[role="menu"]')),
          !Vi.element(s))
        )
          return;
        this.elements.settings.buttons[e].querySelector(
          `.${this.config.classNames.menu.value}`
        ).innerHTML = Wr.getLabel.call(this, e, r);
      ...
      setQualityMenu(e) {
        ...
        Vi.array(e) &&
          (this.options.quality = kr(e).filter((e) =>
            this.config.quality.options.includes(e)
          ));
        const i =
          !Vi.empty(this.options.quality) && this.options.quality.length > 1;
        if (
          (Wr.toggleMenuButton.call(this, t, i),
          tr(n),
      ...
      setCaptionsMenu() {
        ...
        const e = "captions",
          ...
          i = Boolean(n.length);
        if (
          (Wr.toggleMenuButton.call(this, e, i),
          tr(t),
          Wr.checkMenu.call(this),
          !i)
        )
        ...
        const r = n.map((e, n) => ({
          ...
          badge:
            e.language && Wr.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: "language",
        }));
        r.unshift({
          ...
          r.forEach(Wr.createMenuItem.bind(this)),
      ...
      setSpeedMenu() {
        ...
        const n =
          !Vi.empty(this.options.speed) && this.options.speed.length > 1;
      ...
      toggleMenu(e) {
        ...
        if (Vi.boolean(e)) r = e;
          ...
          const i = Vi.function(e.composedPath)
              ? e.composedPath()[0]
              : e.target,
            s = t.contains(i);
        ...
        n.setAttribute("aria-expanded", r),
          ...
          r && Vi.keyboardEvent(e)
            ? Wr.focusFirstMenuItem.call(this, null, !0)
            : r || i || ur.call(this, n, Vi.keyboardEvent(e));
      },
      getMenuSize(e) {
      ...
      create(e) {
        ...
        return (
          kr(
            Vi.array(this.config.controls) ? this.config.controls : []
          ).forEach((o) => {
            if (
            ...
            if (
              ...
              "settings" === o && !Vi.empty(this.config.settings))
            ) {
              const i = Qi(
                "div",
                Ji({}, u, {
            ...
            if (
              ("pip" === o && dr.pip && c.appendChild(n.call(this, "pip", u)),
              "airplay" === o &&
                dr.airplay &&
      ...
      inject() {
        ...
        let n = !0;
        Vi.function(this.config.controls) &&
        ...
        n &&
          ...
          Vi.string(this.config.selectors.controls.container) &&
            (i = document.querySelector(
              this.config.selectors.controls.container
            )),
          Vi.element(i) || (i = this.elements.container);
        if (
          (i[Vi.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            e
          ),
          Vi.element(this.elements.controls) || Wr.findElements.call(this),
          !Vi.empty(this.elements.buttons))
        ) {
          const e = (e) => {
        ...
        if ((Ki.isEdge && Wi(i), this.config.tooltips.controls)) {
          ...
          Array.from(i).forEach((e) => {
            sr(e, this.config.classNames.hidden, !1),
              sr(e, this.config.classNames.tooltip, !0);
          });
        }
      },
      setMediaMetadata() {
    ...
    const Jr = {
        setup() {
          ...
          if (
            !this.isVideo ||
            this.isYouTube ||
            (this.isHTML5 && !dr.textTracks)
          )
            return void (
              Vi.array(this.config.controls) &&
              this.config.controls.includes("settings") &&
              this.config.settings.includes("captions") &&
              Wr.setCaptionsMenu.call(this)
            );
          var e, t;
          if (
            (Vi.element(this.elements.captions) ||
              ((this.elements.captions = Qi(
                "div",
                ir(this.config.selectors.captions)
              )),
          ...
          if (
            (Vi.boolean(r) || ({ active: r } = this.config.captions),
            ...
            e
              ...
              .forEach((e) => {
                this.debug.log("Track added", e),
                  ...
                  fr.call(this, e, "cuechange", () => Jr.updateCues.call(this));
              }),
            ((s && this.language !== n) || !e.includes(r)) &&
              (Jr.setLanguage.call(this, n), Jr.toggle.call(this, t && s)),
            this.elements &&
              sr(
          ...
          if (r !== n) {
            if (
              ...
              return (
                ...
                void Jr.set.call(this, e.indexOf(t))
              );
            }
          ...
          if (-1 !== e)
            if (Vi.number(e))
              if (e in n) {
                ...
                Jr.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && Jr.updateCues.call(this);
        ...
        getLabel(e) {
          ...
          return (
            !Vi.track(t) &&
              dr.textTracks &&
              this.captions.toggled &&
              (t = Jr.getCurrentTrack.call(this)),
            Vi.track(t)
              ? Vi.empty(t.label)
                ? Vi.empty(t.language)
                  ? qr.get("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : qr.get("disabled", this.config)
          );
        },
        updateCues(e) {
          if (!this.supported.ui) return;
          if (!Vi.element(this.elements.captions))
            return void this.debug.warn("No captions element to render to");
          if (!Vi.nullOrUndefined(e) && !Array.isArray(e))
          ...
          if (n !== this.elements.captions.innerHTML) {
            ...
            (e.innerHTML = n),
              ...
              vr.call(this, this.media, "cuechange");
          }
        },
      },
      Xr = {
    ...
    class rs {
      constructor(e) {
        bi(this, "onChange", () => {
          ...
          bi(this, "trapFocus", (e) => {
            if (Ki.isIos || Ki.isIPadOS || !this.active || "Tab" !== e.key)
              return;
          ...
          bi(this, "exit", () => {
            if (this.supported)
              if (Ki.isIos && this.player.config.fullscreen.iosNative)
                this.player.isVimeo
                  ? this.player.embed.exitFullscreen()
                  : this.target.webkitEnterFullscreen(),
                  _r(this.player.play());
              else if (!rs.nativeSupported || this.forceFallback)
      ...
      static get prefix() {
        ...
        return (
          ["webkit", "moz", "ms"].some(
            (t) =>
              !(
                !Vi.function(document[`${t}ExitFullscreen`]) &&
                !Vi.function(document[`${t}CancelFullScreen`])
              ) && ((e = t), !0)
          ),
          e
        );
      ...
      get active() {
        ...
        if (!rs.nativeSupported || this.forceFallback)
          return or(
            this.target,
            this.player.config.classNames.fullscreen.fallback
          );
      ...
      get target() {
        return Ki.isIos && this.player.config.fullscreen.iosNative
          ? this.player.media
    ...
    const os = {
      ...
      build() {
        if ((this.listeners.media(), !this.supported.ui))
          return (
            ...
            void os.toggleNativeControls.call(this, !0)
          );
        Vi.element(this.elements.controls) ||
          (Wr.inject.call(this), this.listeners.controls()),
          ...
          sr(
            ...
            dr.pip && this.isHTML5 && this.isVideo
          ),
          sr(
            this.elements.container,
            this.config.classNames.airplay.supported,
            dr.airplay && this.isHTML5
          ),
          sr(
            this.elements.container,
          ...
          this.poster &&
            os.setPoster.call(this, this.poster, !1).catch(() => {}),
      ...
      setTitle() {
        ...
        if (
          (Vi.string(this.config.title) &&
            !Vi.empty(this.config.title) &&
            (e += `, ${this.config.title}`),
        ...
        sr(
          ...
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            Object.assign(e, {
              ...
              e.setAttribute(
                "aria-label",
                qr.get(this.playing ? "pause" : "play", this.config)
              );
          }),
          (Vi.event(e) && "timeupdate" === e.type) ||
            os.toggleControls.call(this);
      },
      checkLoading(e) {
        ...
        bi(this, "firstTouch", () => {
          ...
          bi(this, "global", (e = !0) => {
            ...
            t.config.keyboard.global &&
              mr.call(t, window, "keydown keyup", this.handleKey, e, !1),
              mr.call(t, document.body, "click", this.toggleMenu, e),
              yr.call(t, document.body, "touchstart", this.firstTouch);
          }),
          bi(this, "container", () => {
            const { player: e } = this,
            ...
            !t.keyboard.global &&
              t.keyboard.focused &&
              fr.call(e, n.container, "keydown keyup", this.handleKey, !1),
              fr.call(
                e,
                n.container,
                ...
                (t) => {
                  ...
                  ["touchstart", "touchmove", "mousemove"].includes(t.type) &&
                    (os.toggleControls.call(e, !0), (s = e.touch ? 3e3 : 2e3)),
                    clearTimeout(i.controls),
                    (i.controls = setTimeout(
                      () => os.toggleControls.call(e, !1),
                      s
                    ));
                }
              );
            ...
            fr.call(e, n.container, "enterfullscreen exitfullscreen", (t) => {
              ...
              r();
              ("enterfullscreen" === t.type ? fr : gr).call(
                e,
                window,
                "resize",
                s
          ...
          bi(this, "media", () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (fr.call(e, e.media, "timeupdate seeking seeked", (t) =>
                Wr.timeUpdate.call(e, t)
              ),
              fr.call(
                e,
                e.media,
                "durationchange loadeddata loadedmetadata",
                (t) => Wr.durationUpdate.call(e, t)
              ),
              ...
              fr.call(e, e.media, "progress playing seeking seeked", (t) =>
                Wr.updateProgress.call(e, t)
              ),
              fr.call(e, e.media, "volumechange", (t) =>
                Wr.updateVolume.call(e, t)
              ),
              fr.call(
                e,
                e.media,
                "playing play pause ended emptied timeupdate",
                (t) => os.checkPlaying.call(e, t)
              ),
              fr.call(e, e.media, "waiting canplay seeked playing", (t) =>
                os.checkLoading.call(e, t)
              ),
            ...
            fr.call(e, e.media, n, (n) => {
              ...
              "error" === n.type && (i = e.media.error),
                vr.call(e, t.container, n.type, !0, i);
            });
          }),
          bi(this, "proxy", (e, t, n) => {
            const { player: i } = this,
            ...
            let s = !0;
            Vi.function(r) && (s = r.call(i, e)),
              !1 !== s && Vi.function(t) && t.call(i, e);
          }),
                  ...
                  [" ", "Enter"].includes(t.key) &&
                    ("Enter" !== t.key
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        Wr.toggleMenu.call(e, t))
                      : Wr.focusFirstMenuItem.call(e, null, !0));
                },
                null,
                !1
              ),
            ...
            this.bind(
              ...
              Ki.isWebKit &&
                Array.from(lr.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, "input", (t) =>
                    Wr.updateRangeFill.call(e, t.target)
                  );
                }),
    ...
    function us(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e),
          vr.call(this, this.media, e ? "play" : "pause"));
    }
    const hs = {
      setup() {
        const e = this;
      ...
      ready() {
        ...
        t.customControls ||
          Ur(Lr(e.config.urls.vimeo.api, d)).then((t) => {
            !Vi.empty(t) &&
              t.thumbnail_url &&
              os.setPoster.call(e, t.thumbnail_url).catch(() => {});
          }),
          ...
          e.embed.on("progress", (t) => {
            (e.media.buffered = t.percent),
              ...
              1 === parseInt(t.percent, 10) &&
                vr.call(e, e.media, "canplaythrough"),
              e.embed.getDuration().then((t) => {
                t !== e.media.duration &&
                  ((e.media.duration = t),
    ...
    const ms = {
        setup() {
          if (
            (sr(this.elements.wrapper, this.config.classNames.embed, !0),
            Vi.object(window.YT) && Vi.function(window.YT.Player))
          )
            ms.ready.call(this);
          else {
        ...
        setup() {
          this.media
            ? (sr(
              ...
              this.isVideo &&
                ((this.elements.wrapper = Qi("div", {
                  class: this.config.classNames.video,
                })),
                Xi(this.media, this.elements.wrapper),
                (this.elements.poster = Qi("div", {
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? ms.setup.call(this)
                : this.isVimeo && hs.setup.call(this))
    ...
    class gs {
      constructor(e) {
        bi(this, "load", () => {
          ...
          bi(
            ...
            "on",
            (e, t) => (
              Vi.array(this.events[e]) || (this.events[e] = []),
          ...
          bi(this, "clearSafetyTimer", (e) => {
            Vi.nullOrUndefined(this.safetyTimer) ||
      ...
      get enabled() {
        ...
        return (
          ...
          this.player.isVideo &&
          e.enabled &&
          (!Vi.empty(e.publisherId) || Vi.url(e.tagUrl))
        );
      }
      get tagUrl() {
        const { config: e } = this;
    ...
    class ws {
        ...
        bi(this, "load", () => {
          ...
          bi(this, "render", () => {
            ...
            (this.elements.thumb.time = Qi("span", {}, "00:00")),
              ...
              Vi.element(this.player.elements.progress) &&
                this.player.elements.progress.appendChild(
                  this.elements.thumb.container
                ),
              (this.elements.scrubbing.container = Qi("div", {
                class:
                  this.player.config.classNames.previewThumbnails
                    .scrubbingContainer,
              })),
          ...
          bi(this, "setScrubbingContainerSize", () => {
            const { width: e, height: t } = bs(this.thumbAspectRatio, {
      ...
      get thumbContainerHeight() {
        if (this.mouseDown) {
          const { height: e } = bs(this.thumbAspectRatio, {
            width: this.player.media.clientWidth,
            height: this.player.media.clientHeight,
          });
          return e;
            ...
            this.destroy.call(
              ...
              () => {
                (this.options.quality = []),
                  er(this.media),
                  (this.media = null),
                  Vi.element(this.elements.container) &&
                ...
                Object.assign(this, {
                  ...
                  this.isHTML5 &&
                    ...
                    _s.insertElements.call(this, "track", e.tracks),
                  ...
                  Vi.empty(e.previewThumbnails) ||
                    ...
                    this.config.previewThumbnails.enabled &&
                      (this.previewThumbnails = new ws(this))),
    ...
    class ks {
      constructor(e, t) {
        if (
          (bi(this, "play", () =>
            Vi.function(this.media.play)
              ? (this.ads &&
                  this.ads.enabled &&
                  this.ads.managerPromise
                    .then(() => this.ads.play())
                    .catch(() => _r(this.media.play())),
                this.media.play())
              : null
          ),
          bi(this, "pause", () =>
            this.playing && Vi.function(this.media.pause)
              ? this.media.pause()
              : null
          ),
          bi(this, "togglePlay", (e) =>
            (Vi.boolean(e) ? e : !this.playing) ? this.play() : this.pause()
          ),
          bi(this, "stop", () => {
            this.isHTML5
              ? (this.pause(), this.restart())
              : Vi.function(this.media.stop) && this.media.stop();
          }),
          bi(this, "restart", () => {
            this.currentTime = 0;
          }),
            ...
            if (this.supported.ui && !this.isAudio) {
              ...
              if (
                (i &&
                  Vi.array(this.config.controls) &&
                  this.config.controls.includes("settings") &&
                  !Vi.empty(this.config.settings) &&
                  Wr.toggleMenu.call(this, !1),
                i !== t)
              ) {
            ...
            this.stop(),
              ...
              this.isHTML5
                ...
                ? (clearInterval(this.timers.buffering),
                  ...
                  null !== this.embed &&
                    Vi.function(this.embed.destroy) &&
                    this.embed.destroy(),
                  n())
                : this.isVimeo &&
          ...
          (this.touch = dr.touch),
          (this.media = e),
          Vi.string(this.media) &&
            (this.media = document.querySelectorAll(this.media)),
          ((window.jQuery && this.media instanceof jQuery) ||
            Vi.nodeList(this.media) ||
            Vi.array(this.media)) &&
        ...
        switch (i) {
          case "div":
            ...
            if (
              Vi.empty(this.provider) ||
              !Object.values(Zr).includes(this.provider)
            )
        ...
        (this.supported = dr.check(this.type, this.provider)),
          this.supported.api
            ? ((this.eventListeners = []),
              ...
              Vi.element(this.elements.container) ||
                ((this.elements.container = Qi("div")),
                Xi(this.media, this.elements.container)),
              ...
              this.isHTML5 &&
                this.config.autoplay &&
                this.once("canplay", () => _r(this.play())),
              (this.lastSeekTime = 0),
              this.config.previewThumbnails.enabled &&
                (this.previewThumbnails = new ws(this)))
      ...
      set muted(e) {
        let t = e;
        Vi.boolean(t) || (t = this.storage.get("muted")),
          Vi.boolean(t) || (t = this.config.muted),
          (this.config.muted = t),
          (this.media.muted = t);
      }
      get muted() {
      ...
      set speed(e) {
        let t = null;
        Vi.number(e) && (t = e),
          Vi.number(t) || (t = this.storage.get("speed")),
          Vi.number(t) || (t = this.config.speed.selected);
      ...
      set download(e) {
        Vi.url(e) &&
          ((this.config.urls.download = e), Wr.setDownloadUrl.call(this));
      }
      set poster(e) {
        this.isVideo
          ? os.setPoster.call(this, e, !1).catch(() => {})
      ...
      set ratio(e) {
        this.isVideo
          ? Vi.string(e) && xr(e)
            ? ((this.config.ratio = Cr(e)), Pr.call(this))
      ...
      set pip(e) {
        ...
        Vi.function(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? Gr : Qr),
          Vi.function(this.media.requestPictureInPicture) &&
            (!this.pip && t
      ...
      get pip() {
        return dr.pip
          ? Vi.empty(this.media.webkitPresentationMode)
            ? this.media === document.pictureInPictureElement
            : this.media.webkitPresentationMode === Gr
          : null;
      }
      ...
      static setup(e, t = {}) {
        ...
        return (
          Vi.string(e)
            ...
            : Vi.nodeList(e)
            ? (n = Array.from(e))
            : Vi.array(e) && (n = e.filter(Vi.element)),
          Vi.empty(n) ? null : n.map((e) => new ks(e, t))
        );
      }
    }
    var Ts;
    ...
    (() => {
      ...
      window.location.host.includes(e) &&
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          function o(e) {
            Array.from(t).forEach((e) =>
              e.parentElement.classList.toggle("active", !1)
            ),
              document
                .querySelector(`[data-source="${e}"]`)
